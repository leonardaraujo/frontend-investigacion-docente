...
import { fGetFullEntregasByPeriodo } from "../../../fetch/fEntregasPeriodo";
...
import {
    ReviewDeliveriesLayout,
    ReviewDeliveriesLoadingLayout,
    ReviewDeliveriesSelectLayout,
    ReviewDeliveriesTableLayout,
    ReviewDeliveriesTitleSelectLayout,
...
const ReviewDeliveries = () => {
    ...
    useEffect(() => {
        ...
        if (selectedPeriodo) {
            setLoadingEntregas(true);
            fGetFullEntregasByPeriodo(selectedPeriodo.value)
                .then((response) => {
    ...
    const handleOpenReviewPopUp = (deliveryId) => {
    ...
    const handleOpenObservationPopUp = (observationId, deliveryId) => {
                ...
                <>
                    ...
                    <ReviewDeliveriesTableLayout>
                        {loadingEntregas ? (
                                                            ...
                                                            <TableRow key={entrega.id}>
                                                                ...
                                                                >
                                                                    <Button
                                                                        ...
                                                                        onClick={() =>
                                                                            handleOpenReviewPopUp(entrega.id)
                                                                        }
                                                                    >
                                                                        Revisar
                                                                    </Button>
                                                                                ...
                                                                                <Paper>
                                                                                    <div style={{ padding: "10px" }}>
                                                                                        ...
                                                                                        <Typography
                                                                                            ...
                                                                                            color="textSecondary"
                                                                                        >
                                                                                            {entrega?.review?.observation?.comments || 
                                                                                                "Sin comentarios"}
                                                                                        </Typography>
                                                                                    </div>
                                                                                </Paper>
                            ...
                            <Box sx={{ mt: 4 }}>
                                <Alert severity="info" variant="outlined">
                                    No hay avances para revisar en este período de investigación.
                                </Alert>
                            </Box>
                        )}
                    </ReviewDeliveriesTableLayout>
