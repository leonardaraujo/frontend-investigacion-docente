			...
			<MenuAppLayout>
				<MenuMainContainer>
					...
					<MenuGrid>
						...
						<CustomNavLink to={"review-deliveries"}>
							Avances a revisar
						</CustomNavLink>
						<CustomNavLink to={"review-final-deliveries"}>
							Entregas finales a revisar
						</CustomNavLink>
					</MenuGrid>
					<AvatarSignOutLayout>
						<Box display="flex" alignItems="center" mb={2}>
							<Avatar sx={{ bgcolor: SECONDARY_COLOR_CONF, mr: 2, color: "black" }}>
								{name.charAt(0)}
							</Avatar>
							<Box>
...
export default SharedLayoutRevisor;
