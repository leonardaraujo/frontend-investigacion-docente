...
const UploadFinalTrabajo = ({ open, onClose, delivery, onUploadSuccess }) => {
	...
	const handleUpload = () => {
		if (selectedFile) {
			...
			axios
				.post(
					"http://localhost:3000/uploadf/entrega-final-comprimido",
					formData,
					{
						headers: {
	...
	return (
		<Dialog open={open} onClose={onClose} maxWidth="sm" fullWidth>
			<DialogTitle>Subir entrega final y turniting</DialogTitle>
			<DialogContent>
				<DialogContentText>
				...
				{!selectedFile && !uploadedFile ? (
					...
					>
						<input data-testid="inputCompressed" {...getInputProps()} />
						{isDragActive ? (
...
export default UploadFinalTrabajo;
