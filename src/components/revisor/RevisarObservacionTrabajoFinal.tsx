...
const RevisarObservacionTrabajoFinal = ({
	open,
	onClose,
	observationId,
	deliveryId,
	...
	console.log("DESDE OBSERVACION FINAL", {
		open,
		onClose,
		observationId,
		deliveryId,
	...
	const handleReviewSubmit = () => {
		...
		const reviewData = {
			...
			user_id: userId,
			comments,
			research_project_id: researchProjectId, // Asegurarse de enviar el researchProjectId
		};
		console.log("Enviando info al servidor",reviewData);
		axios
			.post(
				"http://localhost:3000/reviewf/update_final_observation",
				reviewData,
			)
			.then((response) => {
				console.log(
...
export default RevisarObservacionTrabajoFinal;
